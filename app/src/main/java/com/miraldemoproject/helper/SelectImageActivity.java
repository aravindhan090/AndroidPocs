...
public class SelectImageActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private static String TAG="SelectImageActivity";
    ...
    private void initViews() {
        findViewById(R.id.button_take_a_photo).setOnClickListener(this);
    }
            ...
            try {
                ...
                if (mFilePhotoTaken != null) {
                    mUriPhotoTaken = FileProvider.getUriForFile(this,
                            "com.miraldemoproject.fileprovider1",
                            mFilePhotoTaken);
    ...
    public void dispatchTakePictureIntent() {
        ...
        try {
            ...
            photo = createTemporaryFile("picture_",+Math.random()+".jpg");
            mUriPhotoTaken = Uri.fromFile(photo);
            intent.putExtra(MediaStore.EXTRA_OUTPUT, mUriPhotoTaken);
            //start camera intent
        startActivityForResult(intent,REQUEST_TAKE_PHOTO);
        } catch (Exception e) {
